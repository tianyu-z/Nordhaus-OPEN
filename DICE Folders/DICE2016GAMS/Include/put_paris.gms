...
* Put for Paris Accord

file resultsParis /DICER3-paris.csv/; resultsParis.nd = 10 ; resultsParis.nw = 0 ; resultsParis.pw=20000; resultsParis.pc=5;
put resultsParis;
put /"Results of DICE-2016R model run using model DICER3-Paris.csv";
