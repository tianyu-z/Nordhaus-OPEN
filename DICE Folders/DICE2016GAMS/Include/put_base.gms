...
file resultsbase /DICER3-base.csv/; resultsbase.nd = 10 ; resultsbase.nw = 0 ; resultsbase.pw=20000; resultsbase.pc=5;
put resultsbase;
put /"Results of DICE-2016R model run using model DICER3-base.csv";
