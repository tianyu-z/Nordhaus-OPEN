...
* Put for support Accord

file resultssupport /DICER3-support.csv/; resultssupport.nd = 10 ; resultssupport.nw = 0 ; resultssupport.pw=20000; resultssupport.pc=5;
put resultssupport;
put /"Results of DICE-2016R model run using model DICER3-support.csv";
