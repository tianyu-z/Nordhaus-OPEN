...
file resultsopt_altdam /DICER3-opt_altdam.csv/; resultsopt_altdam.nd = 10 ; resultsopt_altdam.nw = 0 ; resultsopt_altdam.pw=20000; resultsopt_altdam.pc=5;
put resultsopt_altdam;
put /"Results of DICE-2016R model run using model DICER3-opt_altdam.csv";
