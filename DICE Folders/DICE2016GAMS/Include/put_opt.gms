...
file resultsopt /DICER3-opt.csv/; resultsopt.nd = 10 ; resultsopt.nw = 0 ; resultsopt.pw=20000; resultsopt.pc=5;
put resultsopt;
put /"Results of DICE-2016R model run using model DICER3-opt.csv";
